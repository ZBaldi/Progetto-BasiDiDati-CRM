...
CREATE TABLE `nota` (
  ...
  CONSTRAINT `CF_nota` FOREIGN KEY (`CodiceFiscaleCliente`) REFERENCES `cliente` (`CodiceFiscale`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `CodOfferta_nota` FOREIGN KEY (`CodiceOfferta`) REFERENCES `offerta` (`CodiceOfferta`) ON DELETE RESTRICT ON UPDATE CASCADE
